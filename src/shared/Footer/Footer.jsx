...
const Footer = () => {
  return (
    <div className="bg-accent text-white">
      <footer className={` ${GlobalCSS.container} text-white`}>
        <div className="flex justify-between items-center flex-col lg:flex-row md:flex-row">
          <div className="footer p-10  flex justify-between text-white">
            <div>
          ...
          <div className="w-full mb-5 lg:w-fit md:w-fit">
            ...
            <div className="form-control lg:w-80 md:w-80 w-full">
          ...
          <div className="flex items-center justify-center">
            <Link to="#">
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                className="fill-current mr-5 hover:text-primary cursor-pointer"
              >
